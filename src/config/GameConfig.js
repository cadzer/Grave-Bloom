...
export const EVOLUTIONS = {
    arcane_storm: {
        ...
        scale: { damage: 1.30, speed: 1.5, cooldown: 0.7 },
        addPierce: 2,
        addProjectiles: 1,
        color: '#5a8f50',
    ...
    divine_nova: {
        ...
        requiredPassiveLevel: 3,
        requiredWeaponLevel: 8,
        scale: { damage: 1.40, cooldown: 0.8 },
        pulseRadiusBonus: 70,
        healAmount: 4,
        color: '#9ab832',
    ...
    thunder_crown: {
        ...
        baseChainCount: 25,
        baseChainRange: 700,
        scale: { damage: 1.15, cooldown: 0.92 },
        addChainCount: 5,
        chainRangeBonus: 100,
        color: '#60c0ff',
    ...
    blight_plague: {
        ...
        baseCooldown: 1.8,
        baseCloudRadius: 100,
        baseCloudDuration: 5.0,
        baseCloudTick: 0.3,
        scale: { damage: 1.15, cooldown: 0.93 },
        addProjectiles: 1,
        color: '#4a8a2a',
